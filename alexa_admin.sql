...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-01-12 10:58:06
...
--
-- 转存表中的数据 `alexa_artsee`
--

INSERT INTO `alexa_artsee` (`id`, `type`, `rid`, `ip`, `country`, `province`, `city`, `time`) VALUES
...
INSERT INTO `alexa_system` (`id`, `is_close`, `title`, `keywords`, `desc`, `is_mail`, `type`, `record`, `is_update`) VALUES
...
--
-- Indexes for table `alexa_artsee`
--
ALTER TABLE `alexa_artsee`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `alexa_artsee`
--
ALTER TABLE `alexa_artsee`
